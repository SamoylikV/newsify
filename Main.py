...
class mywindow(QtWidgets.QMainWindow):
	...
	def Countri(self):
		...
		self.ui.citi.addItem(self.hometown)
		self.region_lnk = 'https://api.vk.com/method/database.getRegions?country_id=' + str(
			self.countri) + '&count=1000&need_all=1&access_token=' + self.acs + '&v=5.101'
	...
	def Region(self):
		...
		i = self.ui.region.currentIndex()
		self.region = self.region_id[i]
		self.city_lnk = 'https://api.vk.com/method/database.getCities?country_id=' + str(
			self.countri) + '&region_id=' + str(
			self.region) + '&count=1000&need_all=0&access_token=' + self.acs + '&v=5.101'
		...
		if n == 1:
			self.city_lnk = 'https://api.vk.com/method/database.getCities?country_id=' + str(
				self.countri) + '&region_id=' + str(self.region) + '&count=' + str(
				next) + '&offset=1000' + '&need_all=0&access_token=' + self.acs + '&v=5.101'
			self.city = requests.get(self.city_lnk)
			print(self.city_lnk)
			self.city = self.city.text
			self.city = json.loads(self.city)
	...
	def find1(self):
		self.fnd = 'https://api.vk.com/method/execute.next?q=' + self.town + ' ' + self.kat + '&count=150&post=15&age=' + str(
			self.age) + '&start_from=' + str(self.next) + '&access_token=' + self.acs + '&v=5.101'
		self.Site()
	...
	def find(self):
		...
		self.fnd = 'https://api.vk.com/method/execute.newsify?q=' + self.town + ' ' + self.kat + '&count=150&post=15&age=' + str(
			self.age) + '&access_token=' + self.acs + '&v=5.101'  # создание ссылки поиска новостей
		self.Site()
