...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1239, 692)
        MainWindow.setMinimumSize(QtCore.QSize(1234, 700))
        MainWindow.setMaximumSize(QtCore.QSize(1234, 700))
        icon = QtGui.QIcon.fromTheme("icon.png")
        MainWindow.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(2, 3, 1231, 700))
        ...
        self.list.setMaximumSize(QtCore.QSize(522, 16777215))
