...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(3, 2, 1231, 721))
        ...
        self.filter.setStyleSheet(
            '''border-radius: 8px;background-color: rgb(200,200,200);''')  # изменение скругленности и цвета фона комбо-бокса
